function setup(app, handlers, authorisationPolicy) {
    ...
    app.get('/api/games', handlers.game.getActiveGames);
    app.post('/api/:userId/pools', handlers.pools.createPool);

    app.post('/api/:userId/pools/:poolId/games', handlers.pools.addGames);
    app.post('/api/:userId/pools/:poolId/events', handlers.pools.addEvents);
    app.post('/api/:userId/pools/:poolId/participates', handlers.pools.addParticipates);
    app.post('/api/:userId/pools/:poolId/games/:gameId', handlers.bets.createOrUpdate);
